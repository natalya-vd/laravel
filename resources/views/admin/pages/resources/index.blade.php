...
<div class="card w-75 mx-auto">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a class="btn btn-outline-primary" href="{{route('admin.resources.create')}}">
                Добавить ресурс
            </a>
        </div>
        <table class="w-100">
            ...
            <tr>
                ...
                <td class="table__cell">{{$item->link}}</td>
                <td class="table__cell">
                    {{!is_null($item->created_at) ? $item->created_at->format('d-m-Y H:i') : ''}}
                </td>
                <td class="table__cell">
                    <form action="{{route('admin.resources.destroy', $item)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <a href="{{route('admin.resources.edit', $item)}}" class="btn btn-primary">
